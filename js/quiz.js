...
function generateHTML(data) {
    ...
    data.forEach(item => {
        ...
        <div class="bg-white rounded-md my-2">
            ...
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"><span class="text-gray-400"> Quiz:</span><br>${item.title}</h2>
            <div class="mt-10 flex items-center gap-x-6 lg:mt-0 lg:flex-shrink-0">
                <a href="https://quiz.allwomenstalk.com/${item._id}" class="rounded-md bg-pink-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-pink-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600">Start Quiz</a>
